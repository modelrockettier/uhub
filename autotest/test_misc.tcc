...
EXO_TEST(format_size_31, { return test_format(3584 * (size_t)(1 << 20), "3.5 GiB"); });
EXO_TEST(format_size_32, { return sizeof(size_t) < 8 || test_format(((size_t)1 << 40), "1 TiB"); });
EXO_TEST(format_size_33, { return sizeof(size_t) < 8 || test_format(((size_t)1 << 50), "1 PiB"); });
EXO_TEST(format_size_34, { return sizeof(size_t) < 8 || test_format(((size_t)1 << 60), "1 EiB"); });
EXO_TEST(format_size_35, { return sizeof(size_t) < 8 || test_format(10140 * ((size_t)1 << 50), "9.9 EiB"); });
